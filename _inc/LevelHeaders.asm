...
lhead:	macro plc1,lvlgfx,plc2,sixteen,twofivesix,music,pal,col1,objlay,lvllay,bglay
	...
	lhead	plcid_BREW,Kos_BREW,plcid_BREW,Blk16_BREW,Blk256_BREW,bgm_BadEmerald,palid_BREW,Col_BREW,ObjPos_BREW4,Level_BREW4,Level_BREWbg
	...
	lhead	plcid_WIN,Kos_WIN,plcid_WIN,Blk16_WIN,Blk256_WIN,bgm_Final,palid_WIN,Col_WIN,ObjPos_WIN3,Level_WIN3,Level_WINbg
	lhead	plcid_WIN,Kos_WIN,plcid_WIN,Blk16_WIN,Blk256_WIN,bgm_Final,palid_WIN,Col_WIN,ObjPos_WIN1,Level_WIN1,Level_WINbg

	lhead	plcid_Joint,Kos_Joint,plcid_Joint,Blk16_Joint,Blk256_Joint,bgm_Final,palid_Joint,Col_Joint,ObjPos_Joint1,Level_Joint1,Level_Jointbg
	lhead	plcid_Joint,Kos_Joint,plcid_Joint,Blk16_Joint,Blk256_Joint,bgm_Final,palid_Joint,Col_Joint,ObjPos_Joint2,Level_Joint2,Level_Jointbg
	lhead	plcid_Joint,Kos_Joint,plcid_Joint,Blk16_Joint,Blk256_Joint,bgm_Final,palid_Joint,Col_Joint,ObjPos_Joint3,Level_Joint3,Level_Jointbg
	lhead	plcid_Joint,Kos_Joint,plcid_Joint,Blk16_Joint,Blk256_Joint,bgm_Final,palid_Joint,Col_Joint,ObjPos_Joint1,Level_Joint1,Level_Jointbg
	...
	lhead	plcid_Joint,Kos_DVZ,plcid_Joint,Blk16_DVZ,Blk256_DVZ,bgm_Final,palid_DVZ,Col_DVZ,ObjPos_DVZ2,Level_DVZ2,Level_DVZbg
	lhead	plcid_Joint,Kos_DVZ,plcid_Joint,Blk16_DVZ,Blk256_DVZ,bgm_Final,palid_DVZ,Col_DVZ,ObjPos_DVZ3,Level_DVZ3,Level_DVZbg
	lhead	plcid_Joint,Kos_DVZ,plcid_Joint,Blk16_DVZ,Blk256_DVZ,bgm_Final,palid_DVZ,Col_DVZ,ObjPos_DVZ1,Level_DVZ1,Level_DVZbg
	...
	lhead	plcid_NGZ,Kos_NGZ,plcid_NGZ,Blk16_NGZ,Blk256_NGZ,bgm_Final,palid_NGZ,Col_NGZ,ObjPos_NGZ2,Level_NGZ2,Level_NGZbg
	lhead	plcid_NGZ,Kos_NGZ,plcid_NGZ,Blk16_NGZ,Blk256_NGZ,bgm_Final,palid_NGZ,Col_NGZ,ObjPos_NGZ3,Level_NGZ3,Level_NGZbg
	lhead	plcid_NGZ,Kos_NGZ,plcid_NGZ,Blk16_NGZ,Blk256_NGZ,bgm_Final,palid_NGZ,Col_NGZ,ObjPos_NGZ1,Level_NGZ1,Level_NGZbg
