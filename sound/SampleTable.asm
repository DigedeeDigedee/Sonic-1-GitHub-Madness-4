...
SampleTable:
	...
	dcSample	TYPE_PCM,	DAMN,		16000, FLAGS_SFX	; $8E	NOTE: sample rate is auto-detected from WAV file
	dcSample	TYPE_PCM,	SegaPCM,	0, FLAGS_SFX		; $8F	NOTE: sample rate is auto-detected from WAV file
	dc.w	-1	; end marker
