BGM_Retro_Header:
	...
	smpsHeaderVoice     BGM_Retro_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $03

	smpsHeaderDAC       BGM_Retro_DAC
	smpsHeaderFM        BGM_Retro_FM1,	$E5, $04
	smpsHeaderFM        BGM_Retro_FM2,	$FD, $0D
	smpsHeaderFM        BGM_Retro_FM3,	$FD, $10
	smpsHeaderFM        BGM_Retro_FM4,	$FD, $0F
	smpsHeaderFM        BGM_Retro_FM5,	$FD, $10
	smpsHeaderPSG       BGM_Retro_PSG1,	$D9, $00, $00, fTone_03
	smpsHeaderPSG       BGM_Retro_PSG2,	$D9, $00, $00, fTone_05
	smpsHeaderPSG       BGM_Retro_PSG3,	$23, $05, $00, fTone_05
...
BGM_Retro_Loop07:
	...
	smpsLoop            $00, $18, BGM_Retro_Loop07
...
BGM_Retro_Loop01:
	...
	smpsPan             panCenter, $00
	dc.b	nBb4, $04
	smpsLoop            $00, $04, BGM_Retro_Loop01
...
BGM_Retro_Loop02:
	...
	smpsPan             panCenter, $00
	dc.b	nAb4, $04
	smpsLoop            $00, $04, BGM_Retro_Loop02
...
BGM_Retro_Loop03:
	...
	smpsPan             panCenter, $00
	dc.b	nAb4, $04
	smpsLoop            $00, $04, BGM_Retro_Loop03
...
BGM_Retro_Loop04:
	...
	smpsPan             panCenter, $00
	dc.b	nBb4, $04
	smpsLoop            $00, $04, BGM_Retro_Loop04
...
BGM_Retro_Loop05:
	...
	smpsPan             panCenter, $00
	dc.b	nBb4, $04
	smpsLoop            $00, $04, BGM_Retro_Loop05
...
BGM_Retro_Loop06:
	...
	smpsPan             panCenter, $00
	dc.b	nAb4, $04
	smpsLoop            $00, $04, BGM_Retro_Loop06
	smpsPan             panLeft, $00
	dc.b	nAb5, $04, nRst
	smpsPan             panCenter, $00
	dc.b	nEb5, $04, nRst
...
BGM_Retro_Loop08:
	...
	smpsLoop            $00, $03, BGM_Retro_Loop08
	smpsStop
...
BGM_Retro_Loop00:
	...
	smpsLoop            $00, $03, BGM_Retro_Loop00
	...
	smpsPan             panCenter, $00
	dc.b	dKick, $08, nRst, dSnare, nRst, nRst, nRst, nRst, dSnare
	smpsStop
